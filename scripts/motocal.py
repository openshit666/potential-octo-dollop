...
class mcal:
    def __init__(self):
        ...
        fin_f1 = (datetime.now() - timedelta(hours=2)).strftime('%Y%m%d%H%M%S')
        ...
        if int(datetime.strftime(datetime.strptime('{}{}:00'.format(nextf1gp, motocal['f1'][nextf1gp]['carrera']['F1']), '%Y%m%d%H:%M:%S'), '%Y%m%d%H%M%S')) < int(datetime.strftime(datetime.strptime('{}{}:00'.format(nextmotogp, motocal['motogp'][nextmotogp]['carrera']['MotoGP']), '%Y%m%d%H:%M:%S'), '%Y%m%d%H%M%S')):
            self.nextgptext = '{}\nGP {}, {}\nClasificación: {}\nCarrera: {}\n{}'.format(strftime('%A %-d %B', strptime(nextf1gp, '%Y%m%d')).title(), motocal['f1'][nextf1gp]['gp'], motocal['f1'][nextf1gp]['location'], motocal['f1'][nextf1gp]['clasificacion']['F1'], motocal['f1'][nextf1gp]['carrera']['F1'], goodTime(datetime.strptime('{}{}:00'.format(nextf1gp, motocal['f1'][nextf1gp]['carrera']['F1']), '%Y%m%d%H:%M:%S') - datetime.now(), 'FORMULA 1'))
            self.nextgptext += '\n\n{}\nGP {}, {}\nClasificación/Carrera:\nMoto3   {}/{}\nMoto2   {}/{}\nMotoGP  {}/{}\n{}'.format(strftime('%A %-d %B', strptime(nextmotogp, '%Y%m%d')).title(), motocal['motogp'][nextmotogp]['gp'], motocal['motogp'][nextmotogp]['location'], motocal['motogp'][nextmotogp]['clasificacion']['Moto3'], motocal['motogp'][nextmotogp]['carrera']['Moto3'], motocal['motogp'][nextmotogp]['clasificacion']['Moto2'], motocal['motogp'][nextmotogp]['carrera']['Moto2'], motocal['motogp'][nextmotogp]['clasificacion']['MotoGP'], motocal['motogp'][nextmotogp]['carrera']['MotoGP'], goodTime(datetime.strptime('{}{}:00'.format(nextmotogp, motocal['motogp'][nextmotogp]['carrera']['MotoGP']), '%Y%m%d%H:%M:%S') - datetime.now(), 'MOTOGP'))
        else:
            self.nextgptext = '{}\nGP {}, {}\nClasificación/Carrera:\nMoto3   {}/{}\nMoto2   {}/{}\nMotoGP  {}/{}\n{}'.format(strftime('%A %-d %B', strptime(nextmotogp, '%Y%m%d')).title(), motocal['motogp'][nextmotogp]['gp'], motocal['motogp'][nextmotogp]['location'], motocal['motogp'][nextmotogp]['clasificacion']['Moto3'], motocal['motogp'][nextmotogp]['carrera']['Moto3'], motocal['motogp'][nextmotogp]['clasificacion']['Moto2'], motocal['motogp'][nextmotogp]['carrera']['Moto2'], motocal['motogp'][nextmotogp]['clasificacion']['MotoGP'], motocal['motogp'][nextmotogp]['carrera']['MotoGP'], goodTime(datetime.strptime('{}{}:00'.format(nextmotogp, motocal['motogp'][nextmotogp]['carrera']['MotoGP']), '%Y%m%d%H:%M:%S') - datetime.now(), 'MOTOGP'))
            self.nextgptext += '\n\n{}\nGP {}, {}\nClasificación: {}\nCarrera: {}\n{}'.format(strftime('%A %-d %B', strptime(nextf1gp, '%Y%m%d')).title(), motocal['f1'][nextf1gp]['gp'], motocal['f1'][nextf1gp]['location'], motocal['f1'][nextf1gp]['clasificacion']['F1'], motocal['f1'][nextf1gp]['carrera']['F1'], goodTime(datetime.strptime('{}{}:00'.format(nextf1gp, motocal['f1'][nextf1gp]['carrera']['F1']), '%Y%m%d%H:%M:%S') - datetime.now(), 'FORMULA 1'))
